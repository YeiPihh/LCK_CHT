...
const socketio = require('socket.io')(server, {
  cors: {
    origin: ["http://192.168.1.54:3001", "http://localhost:3024", "http://localhost:3000", "http://192.168.1.54:3000", "http://172.25.6.178:3000", "http://172.25.2.26:3000" ],
    methods: ["GET", "POST"],
    credentials: true
  }
});
...
app.use(cors({
  origin: ["http://192.168.1.54:3001", "http://localhost:3001", "http://localhost:3024", "http://192.168.1.54:3000", "http://172.25.6.178:3000", "http://172.25.2.26:3000"],
  credentials: true
}));
